        ...
        if fn is None:
            ...
            extra = (
                ...
                if lm is None
                    ...
                    " (But line magic `%{}` exists, did you mean that instead?)".format(
                        magic_name
                    )
                )
            )
        ...
        *where : tuple
        ...
        with prepended_to_syspath(dname), self.builtin_trap:
            try:
                ...
                execfile(fname, glob, loc, self.compile if shell_futures else None)
        ...
        def error_before_exec(value):
            if store_history:
                if self.history_manager:
                    ...
                    self.history_manager.exceptions[execution_count] = (
