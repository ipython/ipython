...
syntax_ml = \
  dict(classic_prompt =
       ...
       assign_magic =
       [ [('a = %bc de \\', None),
          ('fg', u_fmt("a = get_ipython().run_line_magic('bc', 'de fg')")),
          ],
         [('a = %bc de \\', None),
          ('fg\\', None),
       ...
       assign_system =
       [ [('a = !bc de \\', None),
          ('fg', u_fmt("a = get_ipython().getoutput('bc de fg')")),
          ],
         [('a = !bc de \\', None),
          ('fg\\', None),
...
def test_cellmagic():
    ...
    line_example = [('%%bar 123', None),
                    ('hello', None),
                    ('' , u_fmt("get_ipython().run_cell_magic('bar', '123', 'hello')")),
                   ]
...
def test_token_input_transformer():
    tests = [('1.2', u_fmt("Decimal ('1.2')")),
             ('"1.2"', '"1.2"'),
             ]
    tt.check_pairs(transform_and_reset(decistmt), tests)
    ml_tests = \
    [ [("a = 1.2; b = '''x", None),
       ("y'''", u_fmt("a =Decimal ('1.2');b ='''x\ny'''")),
      ],
      [("a = [1.2,", None),
       ("3]", u_fmt("a =[Decimal ('1.2'),\n3 ]")),
      ],
