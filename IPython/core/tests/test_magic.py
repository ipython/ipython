...
class TestHistoryMagics:
    def test_recall(self, ipython):
        ...
        for idx, cmd in enumerate(cmds, start=1):
            ipython.run_cell(cmd)
            ipython.history_manager.store_inputs(idx, cmd)

        ipython.run_cell('1 + 2')
        ipython.run_line_magic('recall', '')
        assert ipython.rl_next_input == '3'
        ipython.rl_next_input = ''

        ipython.run_line_magic('recall', '1')
        assert ipython.rl_next_input == cmds[0]
        ipython.rl_next_input = ''
        ...
        assert ipython.rl_next_input == cmds[1]
        ipython.rl_next_input = ''
