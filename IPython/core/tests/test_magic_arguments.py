...
def test_magic_arguments():
    ...
    assert getattr(magic_foo1, 'argcmd_name', None) is None
    ...
    assert magic_magic_foo.__doc__ == '::\n\n  %magic_foo [-f FOO]\n\n A docstring.\n\noptional arguments:\n  -f FOO, --foo FOO  an argument\n'
    assert getattr(magic_magic_foo, 'argcmd_name', None) is None
    ...
    assert foo.__doc__ == '::\n\n  %foo [-f FOO]\n\n A docstring.\n\noptional arguments:\n  -f FOO, --foo FOO  an argument\n'
    assert getattr(foo, 'argcmd_name', None) is None
