...
def load_ipython_extension(ip):
    ...
    if not _loaded:
        ...
        plaintext_formatter.for_type_by_name(
            'sympy.matrices.matrices', 'MatrixBase', print_basic_unicode
        )
        ...
        png_formatter.for_type_by_name(
            'sympy.matrices.matrices', 'MatrixBase', print_display_png
        )
        ...
        latex_formatter.for_type_by_name(
            'sympy.matrices.matrices', 'MatrixBase', print_latex
        )
