...
var IPython = (function (IPython) {
    ...
    CodeCell.prototype.create_element = function () {
        ...
        var ccc ;
        var aa = $('<div/>').button({'label':'lalala'}).click(function(){console.log('huhu')});
        var bb = $('<div/>').button({'label':'lalala'}).click(function(){console.log('huhu')});
        var metainner = $('<div/>')
                .append(aa)
                .append(bb).fadeTo('fast',0)
        var metawrapper = $('<div/>').addClass('metaedit')
                .append(metainner)
                .hover(function (){$(metainner).fadeTo("fast",1.0)},function (){$(metainner).fadeTo("fast",0)})

        cell.append( metawrapper);
