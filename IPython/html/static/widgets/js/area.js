...
require([
    ...
    var WidgetArea = function (){
        ...
        // Listen for height changes, echo them to the parent.
        this.height_monitor = new frame.HeightMonitor(widget_area, function(height) {
            that.communicator.send({type: 'resize', 'height': height});
        });
    };
