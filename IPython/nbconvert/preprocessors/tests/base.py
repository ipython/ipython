...
class PreprocessorTestsBase(TestsBase):
    ...
    def build_notebook(self):
        ...
        outputs = [nbformat.new_output(output_type="stream", stream="stdout", output_text="a"),
                   ...
                   nbformat.new_output(
                       output_type="stream", stream="stdout", output_text="c"),
                   nbformat.new_output(
                       output_type="stream", stream="stdout", output_text="d"),
                   nbformat.new_output(
                       output_type="stream", stream="stderr", output_text="e"),
                   nbformat.new_output(
                       output_type="stream", stream="stderr", output_text="f"),
