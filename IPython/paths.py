...
def get_ipython_dir() -> Path:
    ...
    dir_ = env.get("IPYTHONDIR", env.get("IPYTHON_DIR", None))
...
def get_ipython_cache_dir() -> Path:
...
def get_ipython_package_dir() -> Path:
    """Get the base directory where IPython itself is installed."""
    return Path(IPython.__file__).parent


def get_ipython_module_path(module_str) -> Path:
    ...
    if module_str == "IPython":
        return Path(get_ipython_package_dir(), "__init__.py")
...
def locate_profile(profile="default") -> Path:
