...
ipcluster_cmd_argv = [sys.executable, "-m", "ipython_parallel.cluster"]

ipengine_cmd_argv = [sys.executable, "-m", "ipython_parallel.engine"]

ipcontroller_cmd_argv = [sys.executable, "-m", "ipython_parallel.controller"]
...
if WINDOWS and sys.version_info < (3,):
    ...
    ipengine_cmd_argv = [sys.executable, "-c", "from ipython_parallel.engine.__main__ import main; main()"]
    ipcontroller_cmd_argv = [sys.executable, "-c", "from ipython_parallel.controller.__main__ import main; main()"]
